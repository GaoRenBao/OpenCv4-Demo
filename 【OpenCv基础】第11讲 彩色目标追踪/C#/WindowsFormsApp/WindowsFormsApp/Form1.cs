...
namespace WindowsFormsApp
{
    public partial class Form1 : Form
    {
		...
		public void aaa()
        {
			var src = new Mat(@"mandrill.png", ImreadModes.Grayscale);
			var hist = new Mat();
			const int histW = 512;
			const int histH = 400;
			...
			Cv2.CalcHist(images: new[] { src },channels: new[] { 0 },mask: null,hist: hist,dims: 1,histSize: new[] { 256 },ranges: new[] { new Rangef(0, 256) });
			...
			for (int i = 0; i < 256; i++)
			{
				...
				Cv2.Line(histImage, (Point)pt1, (Point)pt2,Scalar.Red, 1, LineTypes.Link8);
			}
