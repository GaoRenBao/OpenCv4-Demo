...
# img = cv2.imread('baboon.jpg',cv2.IMREAD_COLOR)#读入一副彩色图像。图像的透明度会被忽略   默认参数。
# img = cv2.imread('baboon.jpg', cv2.IMREAD_GRAYSCALE)# Load an color image in grayscale 灰度
img = cv2.imread('baboon.jpg',cv2.IMREAD_UNCHANGED)#包括图像的 alpha 通道
