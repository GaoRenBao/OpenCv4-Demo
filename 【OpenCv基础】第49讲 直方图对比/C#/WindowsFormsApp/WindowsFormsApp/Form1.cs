...
namespace WindowsFormsApp
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Mat srcImage_base = Cv2.ImRead("1.jpg");
            Mat srcImage_test1 = Cv2.ImRead("2.jpg");
            Mat srcImage_test2 = Cv2.ImRead("3.jpg");
            //显示载入的3张图像
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                //输出结果
                System.Diagnostics.Debug.WriteLine($"方法[{i}]的匹配结果如下");
                System.Diagnostics.Debug.WriteLine($"【基准图 - 基准图】：{base_base}");
                System.Diagnostics.Debug.WriteLine($"【基准图 - 半身图】：{base_half}");
                System.Diagnostics.Debug.WriteLine($"【基准图 - 测试图1】：{base_test1}");
                System.Diagnostics.Debug.WriteLine($"【基准图 - 测试图2】：{base_test2}\r\n");
            }
            System.Diagnostics.Debug.WriteLine("检测结束。");
            Cv2.WaitKey(0);
        }
    }
}
